...
public enum AuthErrorType implements ErrorType {
    ...
    INCORRECT_VERIFICATION_CODE_EXCEPTION("AUTH400_004", HttpStatus.BAD_REQUEST, "인증번호가 일치하지 않습니다."),
    ...
    INVALID_AUDIENCE_EXCEPTION("AUTH401_005", HttpStatus.UNAUTHORIZED,
            "애플 identityToken 검증 중 audience가 client_id가 아닙니다"),
    INVALID_VERIFICATION_CODE_EXCEPTION("AUTH404_001", HttpStatus.NOT_FOUND, "인증번호가 존재하지 않습니다."),

    APPLE_TOKEN_HEADER_PARSING_EXCEPTION("AUTH500_001", HttpStatus.INTERNAL_SERVER_ERROR,
            "애플 identityToken헤더 파싱 중 에러가 발생했습니다"),
    NOT_MATCHED_APPLE_PUBLIC_KEY_EXCEPTION("AUTH500_002", HttpStatus.INTERNAL_SERVER_ERROR,
            "애플 identityToken의 서명(signature) 검증 중 매칭되는 공개키를 찾을 수 없습니다"),
    APPLE_PUBLIC_KEY_GENERATE_EXCEPTION("AUTH500_003", HttpStatus.INTERNAL_SERVER_ERROR,
            "애플 identityToken의 서명(signature) 검증에서 사용되는 공개키 생성 중 에러가 발생했습니다"),
    NOT_APPLE_ISSUER_EXCEPTION("AUTH500_004", HttpStatus.INTERNAL_SERVER_ERROR,
            "애플 identityToken 검증 중 issuer가 애플이 아닙니다"),
