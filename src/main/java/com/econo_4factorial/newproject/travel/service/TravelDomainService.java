...
import com.econo_4factorial.newproject.travel.dto.TravelAnalysisInput;
...
public class TravelDomainService {
    ...
    public TravelAnalysisResult analyzeTravelStatus(Long courseId, Point prevPoint, Point userPoint, Double prevTotalTravelDistance) {
        ...
        Double totalTravelDistance = Math.round((prevTotalTravelDistance + travelDistance) * 100) / 100.0 ; //소수점 둘 째 짜리까지 표기 km단위.
