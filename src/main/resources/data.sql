...
VALUES(1, '교리터널', '맑음', 25.0, 35.070906194893, 126.979223621632, 120),
      ...
      (1, '입석대', '맑음', 25.0, 35.116271104289275, 126.9884253, 965)
ON DUPLICATE KEY UPDATE name = VALUES(name);
...
VALUES (1, '새인봉-입석대 코스', 6.0, 215, 'NORMAL', 'https://oasis-joa.s3.ap-northeast-2.amazonaws.com/soop/새인봉-입석대+코스.PNG','새인봉 - 입석대',28),
       (1, '늦재-옛길 코스', 9.3, 256, 'NORMAL','https://oasis-joa.s3.ap-northeast-2.amazonaws.com/soop/늦재-옛길.png','원효사 입구 - 입석대 - 원효사 입구',28),
       (1, '당산나무 코스', 3.2, 104, 'EASY','https://oasis-joa.s3.ap-northeast-2.amazonaws.com/soop/당산나무+코스.png','증심사 주차장 - 중머리재',19),
       (1, '시무지기폭포 코스', 10.1, 281, 'NORMAL','https://oasis-joa.s3.ap-northeast-2.amazonaws.com/soop/시무지기폭포+코스.png','증심교 - 장불재 - 인계리',18),
       (1, '너릿재-옛길코스', 14.4,407, 'NORMAL', 'https://oasis-joa.s3.ap-northeast-2.amazonaws.com/soop/너릿재-옛길+코스.png','너릿재 - 서석대 - 원효사 입구',12),
       (1, '안양산-북산코스', 10.7, 324, 'NORMAL', 'https://oasis-joa.s3.ap-northeast-2.amazonaws.com/soop/안양산+-+북산코스.PNG', '무등산편백자연휴양림 - 장불재 - 담양 경상리',18),
       (1, '도원마을-규봉코스', 6.9, 201, 'NORMAL', 'https://oasis-joa.s3.ap-northeast-2.amazonaws.com/soop/도원마을+-+규봉코스.PNG', '도원탐방지원센터 - 장불재 - 영신마을',18),
       (1, '교리-만연산코스', 4.8, 158, 'NORMAL', 'https://oasis-joa.s3.ap-northeast-2.amazonaws.com/soop/교리+-+만연산+코스.PNG', '교리 - 수레바위산 - 만연사',27)
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
