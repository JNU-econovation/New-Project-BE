...
VALUES(1, '교리터널', '맑음', 25.0, 35.070906194893, 126.979223621632),
      ...
      (1, '동화사터', '맑음', 25.0, 35.13311278480902, 126.98549348553924),
      ...
      (1, '서석대', '맑음', 25.0, 35.1209371, 127.0027309),
      (1, '서인봉', '맑음', 25.0, 35.11732844, 126.9810868),
      (1, '시무지기폭포', '맑음', 25.0, 35.1272399, 127.0258408),
      (1, '안양산', '맑음', 25.0, 35.1008716, 127.0192404),
      (1, '원효사', '맑음', 25.0, 35.14848918, 126.9854474),
      (1, '원효사입구', '맑음', 25.0, 35.1477306332732, 126.98512166936014),
      (1, '인계리', '맑음', 25.0, 35.1248164327792, 127.033642594001),
      (1, '장불재', '맑음', 25.0, 35.116271104289275, 126.99861163127287),
      (1, '중머리재', '맑음', 25.0, 35.1190767, 126.9844812),
      (1, '증심교', '맑음', 25.0, 35.1314720337961, 126.96334833116366),
      (1, '증심사주차장', '맑음', 25.0, 35.133446586363135, 126.95784494317081),
      (1, '토끼등', '맑음', 25.0, 35.13108600606006, 126.97777179326329),
      (1, '도원마을(도원탐방지원센터)', '맑음', 25.0, 35.1145825326321, 127.029387653321), -- 추가 데이터 부정확할수 있음
